...
type PossibleValuesType = str | int | float | bool

type MeasurementChannelType = list[dict[str, PossibleValuesType]]

type ParameterChannelType = dict[str, PossibleValuesType | list[PossibleValuesType]]
